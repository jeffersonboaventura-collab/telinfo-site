            ...
            <div className="neon-card p-6 mb-4">
              <div className="flex items-start gap-4 mb-5">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/jefferson-boaventura-da-silva" target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5" style={{fontFamily:"var(--font-mono)",fontSize:"0.6rem",color:"#4499ff"}}>
                    <Linkedin className="w-3 h-3" />linkedin.com/in/jefferson-boaventura-da-silva
                  </a>
                </div>
              </div>
